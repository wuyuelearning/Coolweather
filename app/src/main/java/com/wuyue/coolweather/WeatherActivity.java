...
import com.wuyue.coolweather.gson.Forecast;
import com.wuyue.coolweather.gson.Weather;
import com.wuyue.coolweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        if (weatherString != null) {
            ...
            Log.d("weather", "weatherId1:" + mWeatherId);
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" +
                weatherId + "&key=ecfa3ae47b9b4f13ad22c1ebda17443f";
        Log.d("weather", "weatherId4:" + weatherId);
        Log.d("weather", "weatherUrl:" + weatherUrl);
